...
const Face = ({ linked, onClick }) => {
  ...
  return (
    <svg onClick={onClick} className={styles.unlinkedFace} viewBox="14 24 348 619" version="1.1" xmlns="http://www.w3.org/2000/svg">
      <desc>Sean Kilgarriff Face Logo</desc>
      <g id="Sean-Logo-with-Bowtie" className={styles.unlinkedFace} onClick={onClick} pointerEvents="bounding-box" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd" transform="translate(14.000000, 24.000000)">
